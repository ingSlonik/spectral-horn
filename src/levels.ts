...
const makeEmitter = (a: any): Emitter => {
  ...
  return {
    ...
    angle: a[2] || 0,
    width: a[3] || 7,
    rayCount: isL ? UNIFIED_RAYS : a[4] || UNIFIED_RAYS,
    minLambda: isL ? a[4] : a[5] || 400,
    maxLambda: isL ? a[5] : a[6] || 700,
  };
};
...
// - Emitter:  [x, y, angle=0, width=7, minLambda=400, maxLambda=700] (unified 128 rays)
...
const RAW_LEVELS: any[] = [
  ...
  [
    [[90, 485, 0, 4, 650, 680], [90, 515, 0, 4, 440, 470]],
  ...
  [
    [[90, 240, 0, 7, 650, 680], [90, 760, 0, 7, 525, 545]],
  ...
  [
    [[90, 240, 0, 6], [90, 440, 0.12, 8, 520, 565], [90, 760, 0, 6]],
    [
      [240, 160, 35000],
      [380, 360, ORB, 1.25],
      [240, 860, 35000],
